...
class TunerConfigGenerator:
    ...
    def __init__(self, algorithm: str = "bayes", metrics: str = "validate_avg_loss", objective : str = "minimize", seed: Optional[int] = None, max_combo: int = 0, grid_size: int = 10, min_sample_size: int = 100, retry_limit: int = 20, retry_assign_limit: int = 0, name: Optional[str] = None, trials: int = 1) -> None: ...
